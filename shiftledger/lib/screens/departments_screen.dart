...
class _DepartmentsScreenState extends ConsumerState<DepartmentsScreen> {
  ...
  void initState() {
    super.initState();
    // Initial load happens automatically via the reactive provider or in build
  }
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          IconButton(
            onPressed: () {
              ref.read(departmentProvider.notifier).loadDepartments(search: _searchQuery);
            },
  ...
  Widget _buildContent(
    ...
    if (departments.isEmpty) {
      final error = ref.read(departmentProvider).error;
      return Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(
              error != null ? Icons.error_outline : Icons.business_outlined,
              size: 64,
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            ...
            child: ListTile(
              ...
              onTap: () => _showDepartmentBottomSheet(context, department: dept),
            ),
          );
        },
      );
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: 'e.g. Production, Accounts, HR',
                        border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(12),
                        ),
